...
use App\Http\Controllers\Vendedor\DeliveryVController;
...
use App\Http\Controllers\Vendedor\ProductoVController;
...
Route::middleware(['auth', 'role:cliente'])->group(function () {
    ...
    Route::get('/profile/promocion', [ClienteController::class, 'promocion'])->name('cliente.profile.promocion');
    ...
    Route::prefix('cliente')->middleware('auth')->group(function () {
        ...
        Route::get('/layouts/show/{id}', [CarritoController::class, 'show'])->name('cliente.layouts.show');
    ...
    Route::get('/carrito', [CarritoController::class, 'indexc'])->name('cliente.layouts.indexc');
...
Route::middleware(['auth', 'role:vendedor'])->group(function () {
    ...
    Route::get('/vendedor/producto/index', [ProductoVController::class, 'index'])->name('vendedor.producto.index');
    Route::get('/vendedor/producto/{id}', [ProductoVController::class, 'show'])->name('vendedor.producto.show');

    Route::get('/vendedor/carrito/detalle', [VendedorProducController::class, 'detalleFactura'])->name('vendedor.carrito.detalle'); 
    ...
    Route::prefix('vendedor')->name('vendedor.')->group(function () {
        Route::resource('delivery', DeliveryVController::class);
    });
