    ...
    public function imprimirPDF($id)
{
    ...
    $detalle_factura = $factura->detalleFactura; // Asumiendo que tienes una relación definida

    $pdf = PDF::loadView('vendedor.factura_pdf', compact('factura', 'detalle_factura'));
